...
export const DICIONARIO: Traducoes = {
  ...
  "Não foi possível carregar os canais.": { es: "No se pudieron cargar los canales." },
  "Canal conectado e webhook configurado.": { es: "Canal conectado y webhook configurado." },
  "Canal conectado, mas o webhook precisa ser revisado.": { es: "Canal conectado, pero es necesario revisar el webhook." },
  "WhatsApp por API": { es: "WhatsApp por API" },
  "Conecte uma instância já existente. A credencial é validada no servidor, cifrada no banco e nunca volta para o navegador.": { es: "Conecta una instancia existente. La credencial se valida en el servidor, se cifra en la base de datos y nunca vuelve al navegador." },
  "Escolha o provedor": { es: "Elige el proveedor" },
  "padrão": { es: "predeterminado" },
  "Validando e configurando…": { es: "Validando y configurando…" },
  "O sistema também registra automaticamente o webhook de mensagens e entregas no provedor.": { es: "El sistema también registra automáticamente el webhook de mensajes y entregas en el proveedor." },
  "Canal por API": { es: "Canal por API" },
  "Sem estado": { es: "Sin estado" },
  "Webhook configurado:": { es: "Webhook configurado:" },
